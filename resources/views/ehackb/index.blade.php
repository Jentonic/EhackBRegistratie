            ...
            <div class="lijstsprekers">
                <section class="spreker">
                    ...
                    <div class="scrolloverflow">
                        <p class="info">Na het succes van vorig jaar: een tweede portie van de meest opmerkzame lekken die Inti afgelopen jaar tegen kwam op sites als Facebook en Google. Facebook en Google hebben de beste security engineers ter wereld en toch betalen
                            ze elk jaar miljoenen uit aan ethische hackers. Lekken vinden waar honderden anderen overkijken: naast een klein beetje gelukt vergt het een ferme dosis creativiteit. Inti geeft enkele praktische voorbeelden die je in geen
                            enkel boek terugvindt en zal je meesleuren in de denkwereld van een hacker. Leer hoe je met één simpele e-mail een volledig bedrijf kunt hacken (neen: geen ouderwetse phishing), of hoe je via Facebook anonieme cyberstalkers
                            kan ontmaskeren zoals hij deed voor "Opgejaagd" op VIJFtv. Inti de Ceukelaire is oud Multec student (academiejaar 2015-2016) en is securityblogger en ethisch hacker.</p>
                    </div>
                ...
                <section class="spreker">
                    ...
                    <div class="scrolloverflow">
                        <p class="info">In this presentation, Dr. Valery Vermeulen will give an overview of the several ways he combines his passion for both mathematics and music in several multimedia projects: "EMO-Synth" project, "Krystal Ball," and "Mikromedas."
                            Vermeulen's work within the "EMO-Synth" project revolves around the area of interactive multimedia where automatically generated sound and music systems are directed by the emotional responses of the user. In the "Krystal
                            Ball" project, an interactive multimedia system where the mechanisms that caused the financial credit crisis, stochastic and algorithmic music generation and the work of pioneer I. Xenakis, plays a central role. With his
                            most recent project entitled "Mikromedas," he mainly focusses on the innovative uses of data from space and deep space as new tools shape music composition and performance. Valery Vermeulen is an electronic musician, music
                            producer, mathematician, new media artist, author and a visiting professor at Erasmus University College in Brussels where he teaches "Multimedia Art and Technology." In 2001 he obtained a Ph.D. in pure mathematics at Ghent
                            University (BE), and Between 2001 and 2005 Vermeulen worked at the Institute for Psychoacoustics and Electronic Music at the same university on a research project focusing on the link between music and emotions. Meanwhile,
                            he started writing and recording music in my his production studio. In 2013 he moreover finished a master degree in music composition at the Royal Conservatory of Ghent (BE). Since 2003 Vermeulen has been working on various
                            interactive multimedia projects where the man-machine interaction and crossover between art and science plays a central role. Topics in his work cover a broad range of disciplines including generative art, creative evolutionary
                            systems design, algorithmic sound and image generation, (generative) sound synthesis, affective computing, artificial intelligence, and econometrics.</p>
                    </div>
                    <div class="scrollindicator">
                        Scroll me
                    </div>
                ...
                <section class="spreker">
                    ...
                    <div class="scrolloverflow">
                        <p class="info">Luk Schoonaert, director of Technology bij Exclusive Networks, komt ons een stand van zaken geven omtrent cybersecurity en de trends van de laatste jaren (cryptolockers, DDOS, Internet of things, …). Hoe kunnen we ons beschermen?
                            Na deze sessie kan je terecht bij zijn collega Steven Eerdekens voor een workshop, waar je aan de slag gaat met Palo Alto firewalls.</p>
                    </div>
                </section>
                <section class="spreker">
                    ...
                    <div class="scrolloverflow">
                        <p class="info">Wannes is een laatstejaarsstudent Dig-X (Toegepaste Informatica), optie Software Engineering aan de Erasmushogeschool. Hij heeft een passie voor software design en web applicaties. Wannes bespreekt de technologieën achter realtime
                ...
                <section class="spreker">
                    ...
                    <div class="scrolloverflow">
                        <p class="info">Vroeg je je ooit al af hoe je aan Virtual Reality development begint? Wat de Do’s en Dont’s zijn? Welke tools je hiervoor kan gebruiken? In deze sessie duiken we een beetje dieper in de Unity3D engine en de integratie van de
                            Oculus Rift. Aan de hand van live coding demo’s wordt er getoond hoe je aan de slag kan gaan om je eigen VR applicaties te bouwen en te optimaliseren voor een leuke user experience.</p>
                    </div>
                </section>
                <div class="clear"></div>
            </div>
        ...
        <div class="games">
            ...
            <div class="lijstgames">
                <section class="game">
                    ...
                    <div class="scrolloverflow">
                        <p class="info">Voor het League of Legends tornooi gaan we werken met een poulesysteem waarbij er 2 poules van 6 teams zijn. Elk team zal eenmaal tegen elk team spelen en de 4 teams die het meeste hebben gewonnen gaan door naar de volgende
                            ronde. In deze ronde zal er met een bracket systeem gewerkt worden voor de 8 overblijvende teams. Als je wint ga je door naar de volgende ronde in de bracket als je verliest is het gedaan. We gebruiken de custom draft game
                            mode voorzien door het spel zelf. Er zullen ook vaak mods en streamers aanwezig zijn in deze games om zo het tornooi vlot te laten verlopen. Who will be the last one standing on the Rift?</p>
                    </div>
                    <div class="scrollindicator">
                        Scroll me
                    </div>
                ...
                <section class="game">
                    ...
                    <p class="hour">20.00 - ...</p>
                    <div class="scrolloverflow">
                        <p class="info">Voor het Counter Strike: Global Offensive starten we met een poulesysteem waarbij er 2 poules van 6 teams zijn. Elk team zal eenmaal tegen elk team spelen en de 4 teams die het meeste hebben gewonnen gaan door naar de volgende
                            ronde. In deze ronde zal er met een bracket systeem gewerkt worden voor de 8 overblijvende teams. Als je wint ga je door naar de volgende ronde in de bracket als je verliest is het gedaan. De games worden gespeeld op servers
                ...
                <section class="game">
                    ...
                    <p class="hour">20.00 - ...</p>
                    <div class="scrolloverflow">
                        <p class="info">Toon je vermogen in overwatch en neem het op tegen 5 andere teams om te bewijzen dat jullie dit jaar de kampioen zijn.<br><br> Regels:
                            <br><br> Het tornooi wordt opgedeeld in de volgende rondes:
                            <br><br> Voorrondes: 6 teams spelen tegen elkaar in 5 wedstrijden, best of 1. De gespeelde map wordt door de team-captain gekozen via de OWdraft website, waarvan ze een link krijgen van de overwatchbalie via battlenet.
                            De 4 beste teams gaan door naar de halve finale en de 2 verliezende teams zijn geëlimineerd.
                            <br><br> Halve finale: Hierin zitten 4 teams. Een team van een groep speelt tegen een ander team van de andere groep. Er worden hier 3 matches gespeeld. Waarbij de 3 maps in het begin worden gekozen via OWdraft. De winnaars
                            worden gekozen met een best of 3 methode.
                            <br><br> Finale: Hier gaan de 2 overblijvende teams tegen elkaar spelen zoals in de halve finale, met een best of three over de 3 verschillende objectives. De winnaar wint het overwatch toernooi.
                ...
                <section class="game">
                    ...
                    <div class="scrolloverflow">
                        <ul class="info">
                            ...
                            <p>Je kiest 1 character uit een grote verzameling van Nintendo characters om jezelf naar de top te vechten.</p><br/>

                            <p>Regels:<br/>
                                Het toernooi bestaat uit 2 rondes, de eliminatie- en de finaleronde</p><br/>

                            <p>Indien er een speler niet komt opdagen wordt zijn match uitgesteld tot het einde van de ronde, komt hij dan nog niet opdagen betekent het een directe diskwalificatie.
                                Controllers zullen ter beschikking gesteld worden. Uit eigen veiligheid is het aangeraden om je eigen controller mee te nemen. Er wordt ook genoeg tijd voorzien om de settings van je controller in te stellen (indien dit moet gebeuren).</p><br/>
                            ...
                            <p>Finalefase:
                                Eerste en tweede plaats van beide groepen gaan door naar de finalefase om uit te vechten wie de uiteindelijk winnaar wordt. Als prijs zijn er twee amiibo’s beschikbaar. De winnaar mag kiezen welke amiibo hij/zij wilt. De tweede plaats wint de overige amiibo.</p>
                        </ul>
                    </div>
                </section>
                <section class="game">
                    ...
                    <p class="hour">20.00 - ...</p>
                    <div class="scrolloverflow">
                        <p class="info">Durf je je talent en skills te komen tonen op het voetbalveld, en als deze goed genoeg zijn kans te maken op een prijs? Dan is ons FIFA17 Toernooi de perfecte opportuniteit voor jou! Registreer je snel omdat er maar slechts
                        ...
                        <br>
                        <p class="info">
                            Het toernooi wordt op PS4 gespeeld. Wanneer een deelnemer verliest wordt hij/zij geëlimineerd. De deelnemers zullen gevraagd worden, door het centrale streaming, te komen opdagen een paar minuten voor de match. Als deze na vijf minuten het einde van de
                ...
                <section class="game">
                    ...
                    <div class="scrolloverflow">
                        <p class="info">
                            Zoals elk jaar wordt er een hearthstone toernooi georganiseerd op EHackB. Toon je “skills” aan je medeleerlingen en geef niet op tot je als laatste overblijft. Laat je zeker niet afschrikken door de tegenstand en probeer zeker zelf ook zo ver mogelijk
                            te raken in de bracket.
                            <br><br> Elke speler bereidt 3 decks van 3 verschillende classes voor, deze worden niet meer veranderd voor de rest van het toernooi. De decks worden in het standaard formaat gespeeld, dat wil zeggen dat je geen kaarten
                            mag gebruiken uit de "Goblins VS Gnomes" en "Blackrock Mountain". Er worden geen accounts gedeeld, één account kan maar één keer ingeschreven worden. Elke match bestaat uit een best of 5, spelers moeten met alle 3 hun decks
                            een game winnen, de eerste die wint met al zijn decks gaat door naar de volgende ronde. Afhankelijk van de hoeveelheid spelers zal er misschien ook nog een losersbracket zijn. Alle games worden op de Europese servers gespeeld.
                ...
                <section class="game">
                    ...
                    <p class="hour">23.00 - ...</p>
                    <div class="scrolloverflow">
                        <p class="info">Denk jij tegen de pro's op te kunnen? Laat dan jouw skills zien op ons 1v1 rocket league toernooi. Het toernooi wordt gespeeld op voorziene computers die plaatsvinden op het evenement zelf. De enige vereiste is dat je zelf
        ...
        <div class="timetable">
            ...
            <section class="tableitem create">
                ...
                <div class="table">
                    <ul>
                        <li>
                            <p> We starten EhackB dit jaar met enkele externe en interne sprekers die een belangrijke bijdrage leveren aan het drieluik hack, create en game. Er is geen voorkennis vereist om de keynotes bij te wonen. Na de keynotes openen
                                we al onze corners en starten de workshops.</p>
                            <br>
                            <p>In verschillende corners worden opstellingen voorzien die we stap voor stap doorlopen om je wegwijs te maken in de wereld van hedendaagse cybersecurity. De corners worden opgedeeld in verschillende instapniveaus. Is je
                                kennis omtrent programmeren of website-ontwikkeling beperkt, dan doorlopen de begeleiders van de corners samen met jou stap voor stap de tools die echte hackers gebruiken. Zo kan iedereen zich op zijn eigen tempo inwerken
                                in de verschillende hack-technieken. Je eigen laptop of computer meebrengen mag, maar is zeker niet noodzakelijk.</p>
                            <br>
                            <p>Ook de gamers krijgen een mooi programma voorgeschoteld. In totaal worden er 3 competities voorgeschoteld: Counter-Strike: Global Offensive, League of Legends en Overwatch. De competities worden gelivestreamd zodat iedereen
                                alles op de voet kan volgen op twitch. Hiernaast bieden we enkele kleine competities aan. Deze zijn onder andere een Hearthstone competitie, een FIFA toernooi en een Super Smash Bros. Wii U competitie! Voor mensen die
                                niet steeds achter hun pc willen zitten zijn er dit jaar enkele boardgames aanwezig. De niet competitieve gamers zijn net als de rest welkom om mee te gamen.</p>
                            <br>
                            <p>In de create corner laten we de creatieve breinen los op een hoop hardware. Door gebruik te maken van onder andere Arduino’s, motor shields en ander materiaal kunnen deelnemers hun skills meten in robot races, een arena
                                of een leuke voetbalwedstrijd. Voor de developers voorzien we twee hackathons, zowel Unity als Processing, waar leuke prijzen aan vast hangen. De designers kunnen zich dan weer uitleven met ludieke Photoshop en 3D modeling
                            </p>challenges.
                            <br>
                            <br>
    ...
    <article id="locatie" class="element">
        <div class="contentLocatie">
            ...
            <section class="public">
                ...
                <div class="loccontainer">
                    <h4>Trein</h4>
                    <p>Campus Kaai is snel bereikbaar vanaf het Zuidstation dankzij metrolijnen 2 en 6. Afstappen in metrostation Delacroix.</p>
                    <h4>Metro</h4>
                    <p>Delacroix: lijn 2 en lijn 6.</p>
                    <h4>Bus en tram</h4>
                    <p>Trams 31 en 81 vanaf Brussel-Zuid. Bus 46 vanaf De Brouckère of Washuis. Voor meer informatie over de tram en bus in Brussel kan je terecht op de website van de MIVB. Meer informatie over de bussen van De Lijn vind je op de website.</p>
                </div>
            </section>
            <section class="car">
                ...
                <h3>auto</h3><br>
                <div class="loccontainer">
                    <p>Parkeren kan gemakkelijk voor of achter de campus. De binnenparking tussen A & B zijn dit jaar ook toegankelijk. (Beperkte & onbewaakte parking)</p>
                </div>
            </section>
            <section class="map">
